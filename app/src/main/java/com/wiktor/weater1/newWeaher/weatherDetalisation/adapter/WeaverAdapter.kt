...
class WeaverAdapter(private val list: List<WeatherModelForView>) : RecyclerView.Adapter<WeaverAdapter.MyWeatherViewHolder>() {
    ...
    inner class MyWeatherViewHolder(view: View) : RecyclerView.ViewHolder(view) {

        private var date: TextView = view.item_text_view_date
        private var maxTemp: TextView = view.item_text_view_max_temp
        private var image: ImageView = view.item_image_view
